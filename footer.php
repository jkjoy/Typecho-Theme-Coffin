...
<footer class="site-footer">
    <div class="layoutSingleColumn--wide">© <?php echo date('Y'); ?> <?php $this->options->title(); ?>
        Powered by <a href="https://typecho.org/" target="_blank">Typecho</a> &amp;
        theme by <a href="https://fatesinger.com" target="_blank">bigfa</a> & <a href="https://www.imsun.org" target="_blank">Sun</a>.    &nbsp;页面加载耗时<?php echo timer_stop();?> 
    </div>
</footer>
    <div class="backToTop">
