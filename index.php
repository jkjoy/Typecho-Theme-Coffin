                ...
                <div class="sandraItem--content">
                    <div class="sandraItem-meta">
                        <h2 class="sandraItem-title" itemprop="headline">
                            <a href="<?php $this->permalink() ?>" aria-label="<?php $this->title() ?>" title="<?php $this->title() ?>"><?php if (isset($this->isSticky) && $this->isSticky): ?><?php echo $this->stickyHtml; ?><?php endif; ?><?php $this->title() ?></a>
                        </h2>
                    </div>
