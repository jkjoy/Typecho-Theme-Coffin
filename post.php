...
<div class="authorCard--imageWrapper">
    <img alt='' src='<?php $this->options->logoUrl() ?>' height='72' width='72' decoding='async'/>
</div>
<div class="authorCard--content">
    <h3 class="authorCard--title"><?php $this->author(); ?></h3>
